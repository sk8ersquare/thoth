...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            transcription::init_lightning_whisper_transcription,
            transcription::init_mlx_whisper_transcription,
            transcription::mlx_whisper::is_mlx_whisper_available,
            transcription::mlx_whisper::install_mlx_whisper,
